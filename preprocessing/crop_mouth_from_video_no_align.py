...
""" Crop Mouth ROIs from videos for lipreading without alignment"""
...
#            trans_landmarks = trans(cur_landmarks)
            # -- crop mouth patch
            sequence.append( cut_patch( cur_frame,
                                        cur_landmarks[args.start_idx:args.stop_idx],
                                        args.crop_height//2,
                                        args.crop_width//2,))
...
#                trans_landmarks = trans(q_landmarks.popleft())
                # -- crop mouth patch
                sequence.append( cut_patch( cur_frame,
                                            q_landmarks.popleft()[args.start_idx:args.stop_idx],
                                            args.crop_height//2,
                                            args.crop_width//2,))
